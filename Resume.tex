...
\section{Platforms}
\resumeSubHeadingListStart
\resumeSubItem{LeetCode}{~~~~~~~~~~Solved over {\color{blue}\href{https://leetcode.com/van_astrea/}{\textbf{600}}} problems consistently }
	...
	\resumeSubItem{GeeksForGeeks}{~Over {\color{blue}\href{https://auth.geeksforgeeks.org/user/pchhabra2002}{\textbf{150}}} problems solved with a coding score of more than 500}
  \resumeSubItem{Udemy}{~~~~~~~~~~~~~{Complete MERN Stack Guide - {\color{blue}\href{https://www.udemy.com/certificate/UC-99a0971b-88a3-4e0f-add9-9716ff951fad/}{\textbf{See Certificate}}}}~~~
  {C++ Basic to Advance - {\color{blue}\href{https://www.udemy.com/certificate/UC-1be57826-91db-47b9-a76e-145e9b139ab4/}{\textbf{See Certificate}}}}}
\resumeSubHeadingListEnd
\vspace{2pt}
...
%-----------PROJECT - 1-----------------
\resumeSubheading
{TravelElite - A TRAVEL BLOG WEBSITE} {\color{blue}\href{http://15.206.146.73/}{Live} | \href{https://github.com/p-chhabra/TravelElite}{Github}}
{Tech Stack - \textbf{React, Express, MongodDB, Google Maps/GeoCoding API, AWS EC2}} {}
\vspace{-3pt}
\resumeItemListStart
